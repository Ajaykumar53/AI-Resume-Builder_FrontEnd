...
import { updateEducation } from "../../store/ResumeData";
...
export default function Education({ Next }) {
  ...
  const [educationCount, setEducationCount] = useState(formData.length);
  ...
  const validateForm = (data) => {
    ...
    data.forEach((edu, index) => {
      Object.entries(requiredFields).forEach(([key, label]) => {
        if (!edu[key]?.trim()) {
          errors[`education-${index}-${key}`] = `${label} is required`;
        }
      });
    });
    return errors;
  ...
  useEffect(() => {
    if (education.length > 0) {
      if (JSON.stringify(formData) !== JSON.stringify(education)) {
  ...
  const removeEducation = (index) => {
    setEducationCount((prev) => Math.max(1, prev - 1));
  ...
  const Save_AND_Next = () => {
    ...
    Next();
    setFormData([...education]); // Reset form to Redux state
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-gray-600 mb-6">
        Include your educational history, focusing on degrees, certifications,
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="space-y-2">
                ...
                >
                  Institution Name <span className="text-blue-500">*</span>
                </label>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  />
                  {formErrors[`education-${index}-degree`] && (
                    <p className="text-xs text-red-500 mt-1">
                      {formErrors[`education-${index}-degree`]}
                    </p>
                  )}
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 
                             ...
                             transition-colors duration-200"
                  />
                  {formErrors[`education-${index}-educationStartDate`] && (
                    <p className="text-xs text-red-500 mt-1">
                      {formErrors[`education-${index}-educationStartDate`]}
                    </p>
                  )}
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 
                             ...
                             transition-colors duration-200"
                  />
                  {formErrors[`education-${index}-educationEndDate`] && (
                    <p className="text-xs text-red-500 mt-1">
                      {formErrors[`education-${index}-educationEndDate`]}
                    </p>
                  )}
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="3.8/4.0"
                  />
                  {formErrors[`education-${index}-gpa`] && (
                    <p className="text-xs text-red-500 mt-1">
                      {formErrors[`education-${index}-gpa`]}
                    </p>
                  )}
        ...
        <div className="mt-8 pt-6 border-t border-gray-100">
          <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-lg">
            ...
            <div className="text-sm text-blue-800">
              <p className="font-medium">Pro Tips for Listing Education:</p>
              <ul className="mt-2 space-y-1 list-disc pl-5">
                <li>List most recent education first</li>
                <li>Include relevant coursework for recent graduates</li>
                <li>Highlight honors or special recognition</li>
                <li>For older degrees, focus on relevance to target role</li>
              </ul>
            </div>
          </div>
        </div>
